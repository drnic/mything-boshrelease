...
# The base manifests/mything.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/mything.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
